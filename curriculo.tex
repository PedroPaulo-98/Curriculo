...
\begin{description}
  ...
  \item[Experiências] PHP, Laravel, Python, FastAPI, Django, Flutter, Java, HTML, CSS, .Net, React, Ruby, Delphin, Quarkus, SQL, GIT, Docker, Portainer, BI, Dashboards, Mikrotik, entre outras tecnologias
\end{description}
...
\subsubsection{Desenvolvedor Full Stack (atuando como desenvolvedor no PRODAP) \rside{Macapá, AP}}
\begin{itemize}
  \item Desenvolvimento de sistemas (Laravel, Django, AdonisJS, React e outros)
  ...
  \item Infraestrutura (Portainer, HTTPD (Apache e Ngnix) e Configuração de servidor)
\end{itemize}
...
\begin{itemize}
  \item Sistema de certifiação de produtos estaduais no estado do Amapá
\end{itemize}
